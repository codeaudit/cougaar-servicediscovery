...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0001ServiceDiscoveryBootstrapping','$$CP=org.cougaar.servicediscovery.plugin.MatchmakerStubPlugin-1',4.000000000000000000000000000000,'recipeQueryAllAgents');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0001ServiceDiscoveryBootstrapping','$$CP=org.cougaar.servicediscovery.plugin.SDClientPlugin-0',2.000000000000000000000000000000,'recipeQueryAllAgents');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0001ServiceDiscoveryBootstrapping','$$CP=org.cougaar.servicediscovery.plugin.SDProviderPlugin-2',3.000000000000000000000000000000,'recipeQueryAllAgents');
