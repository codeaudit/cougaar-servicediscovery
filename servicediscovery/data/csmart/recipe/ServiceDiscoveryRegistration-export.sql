...
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('DAML|org.cougaar.servicediscovery.servlet.CougaarDAMLServlet','DAML|org.cougaar.servicediscovery.servlet.CougaarDAMLServlet','plugin|org.cougaar.servicediscovery.servlet.CougaarDAMLServlet','plugin',0.000000000000000000000000000000);
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('DAML|org.cougaar.servicediscovery.servlet.CommonWSDLServlet','DAML|org.cougaar.servicediscovery.servlet.CommonWSDLServlet','plugin|org.cougaar.servicediscovery.servlet.CommonWSDLServlet','plugin',0.000000000000000000000000000000);
REPLACE INTO alib_component (COMPONENT_ALIB_ID, COMPONENT_NAME, COMPONENT_LIB_ID, COMPONENT_TYPE, CLONE_SET_ID) VALUES ('DAML|org.cougaar.servicediscovery.plugin.DAMLReadyPlugin','DAML|org.cougaar.servicediscovery.plugin.DAMLReadyPlugin','plugin|org.cougaar.servicediscovery.plugin.DAMLReadyPlugin','plugin',0.000000000000000000000000000000);
...
REPLACE INTO lib_component (COMPONENT_LIB_ID, COMPONENT_TYPE, COMPONENT_CLASS, INSERTION_POINT, DESCRIPTION) VALUES ('DAML','agent','org.cougaar.core.agent.ClusterImpl','Node.AgentManager.Agent','Added agent');
...
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0006ServiceDiscoveryRegistration','$$CP=org.cougaar.servicediscovery.plugin.LineagePlugin-3',2.000000000000000000000000000000,'recipeQueryAllAgents');
REPLACE INTO lib_mod_recipe_arg (MOD_RECIPE_LIB_ID, ARG_NAME, ARG_ORDER, ARG_VALUE) VALUES ('RECIPE-0006ServiceDiscoveryRegistration','$$CP=org.cougaar.servicediscovery.plugin.SDRegistrationPlugin-4',6.000000000000000000000000000000,'recipeQueryAllAgents');
